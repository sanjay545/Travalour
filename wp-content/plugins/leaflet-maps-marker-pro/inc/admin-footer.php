	...
	<table cellpadding="5" cellspacing="0" style="margin-top:20px;border:1px solid #ccc;width:100%;background:#F9F9F9;">
	  <tr>
		...
		<p style="margin:0px;">
				...
				<a style="text-decoration:none;" href="http://twitter.com/mapsmarker" target="_blank"><img src="<?php echo LEAFLET_PLUGIN_URL; ?>inc/img/icon-twitter.png" width="16" height="16" alt="<?php esc_attr_e('Follow @MapsMarker on Twitter','lmm'); ?>"> Twitter</a>&nbsp;
				<a style="text-decoration:none;" href="http://facebook.com/mapsmarker" target="_blank"><img src="<?php echo LEAFLET_PLUGIN_URL; ?>inc/img/icon-facebook.png" width="16" height="16" alt="<?php esc_attr_e('Follow MapsMarker on Facebook','lmm'); ?>"> Facebook</a>&nbsp;
				...
				<a style="text-decoration:none;" href="https://www.mapsmarker.com/changelog" target="_blank"><img src="<?php echo LEAFLET_PLUGIN_URL; ?>inc/img/icon-changelog-header.png" width="16" height="16" alt="<?php esc_attr_e('Changelog','lmm'); ?>"> <?php _e('Changelog','lmm') ?></a>&nbsp;
