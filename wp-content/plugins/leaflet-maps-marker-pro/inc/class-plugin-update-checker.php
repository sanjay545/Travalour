 ...
 * http://w-shadow.com/
 * Last commit (https://github.com/YahnisElsts/plugin-update-checker/commits/): October 24, 2014 - Fixed automatic background updates not working for plugins that use...
