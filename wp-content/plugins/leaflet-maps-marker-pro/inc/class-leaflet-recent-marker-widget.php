...
class Class_leaflet_recent_marker_widget extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		$included_layers = ($instance['lmm-widget-included-layers'] == NULL) ? '' : esc_sql($instance['lmm-widget-included-layers']);
		$exclude_markers = ($instance['lmm-widget-exclude-markers'] == NULL) ? '' : esc_sql($instance['lmm-widget-exclude-markers']);
		$exclude_layers = ($instance['lmm-widget-exclude-layers'] == NULL) ? '' : esc_sql($instance['lmm-widget-exclude-layers']);
